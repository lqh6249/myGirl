define(['jquery', 'bootstrap', 'backend', 'table', 'form', 'template'], function ($, undefined, Backend, Table, Form, Template) {
    ...
    var Controller = {
        index: function () {
            ...
            Table.api.init({
                extend: {
                    "index_url": "auth/menu/index",
                    "add_url": "auth/menu/add",
                    "edit_url": "auth/menu/edit",
                    "del_url": "auth/menu/del",
                    "multi_url": "auth/menu/multi",
                    "table": "auth_menu"
                }
            });
            ...
            table.bootstrapTable({
                ...
                columns: [
                    [
                        ...
                        {field: 'id', title: 'ID'},
                        {field: 'title', title: '菜单名称', align: 'left', align: 'left', formatter: Controller.api.formatter.title},
                        {field: 'icon', title: '菜单图标', formatter: Controller.api.formatter.icon},
                        {field: 'name', title: '菜单标识', align: 'left', formatter: Controller.api.formatter.name},
                        {field: 'status', title: '菜单状态', formatter: Table.api.formatter.status},
            ...
            bindevent: function () {
                ...
                $(document).on('click', ".btn-search-icon", function () {
                    if (iconlist.length == 0) {
                        $.get(Config.site.cdnurl + "/assets/admin/libs/font-awesome/less/variables.less", function (ret) {
                            var exp = /fa-var-(.*):/ig;
                            var result;
