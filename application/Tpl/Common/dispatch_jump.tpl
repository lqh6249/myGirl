...
<html lang="en">
    <head>
        ...
        <link rel="shortcut icon" href="__CDN__/assets/admin/img/favicon.ico" />
        <style type="text/css">
    ...
    <body>
        <div class="system-message <?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>">
            <div class="image">
                <img src="__CDN__/assets/admin/img/<?php echo $code == 1 ? 'success' : ($code == 0 ? 'error' : 'info');?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo($msg);?></h1>
            <p class="jump">
